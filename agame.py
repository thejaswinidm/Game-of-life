...
class Controls(object):
    def __init__(self, width: int):
        ...
        #self.cell_buttons = self.view.top_panel.cell_buttons()
        self.color_dict = {
            0: 'white', 1: 'black'
        }
        self.count = set()
    ...
    def reveal(self, index: Tuple[int, int]):
        ...
        # cells_unrevealed = self.width * self.width - len(self.cells_revealed) - 1
        ...
        #self.view.buttons[x][y].configure(text=1, bg=self.color_dict[0])
